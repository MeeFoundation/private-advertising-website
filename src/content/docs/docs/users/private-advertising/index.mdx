---
title: Getting Started For Private Advertising Users
description: Getting Started with Private Advertising Users
sidebar:
...
This project applies the Mee experience to internet advertising. It includes a front-end component, the *Mee Extension,* as well as back-end services including an *Interest Service* and a *Private Ad Network*. The company logos in the following diagram below are purely hypothetical/aspirational:
